...
<body>
	...
	<section class="section area">
		...
		<form action="freeinsertres.do" method="post">
			<input type="hidden" name="free_writer"
			...
			<table class="free_insert">
				...
				<thead>
					<tr>
						<th>FREE BOARD</th>
						<td><input type="text" name="free_title"
							style="height: 100%;" placeholder="제목을 입력하세요." /></td>
					</tr>
				</thead>

				<tbody>
					<tr>
						<td colspan="2" class="free_content"><textarea rows="10"
								cols="122" name="free_content" placeholder="내용을 입력하세요."></textarea>
						</td>
					</tr>
				</tbody>

<%@page import="com.kh.onsu.pay.model.dto.PayDto"%>
...
<script type="text/javascript">
	...
	IMP.request_pay({
		...
		window.location.href="listenInsert?member_id=" + document.getElementsByName("member_id")[0].value
	      ...
	      window.location.href="payDelete?pay_memberid=" + document.getElementsByName("member_id")[0].value

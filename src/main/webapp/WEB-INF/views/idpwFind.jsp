...
<head>
<meta charset="UTF-8">
<title>On:Su - ID/PW Find Page</title>
</head>
				...
				<form action="idfind" method="post">
					<div class="idfindbox">
						...
						<div>
							...
							<div>
								<input class="findinput" type="text" name="member_name" id="member_name" placeholder="이름을 입력해주세요">
							</div>
						</div>
						<div>
							<div class="subtitle">이메일</div>
							<div>
								<input class="findinput" type="email" name="member_email" id="member_email" placeholder="이메일을 입력해주세요"> 
								<input class="idbtn" type="submit">
							</div>
						</div>
					</div>
				</form>
				...
				<form action="pwfind" method="post">
					<div>
						...
						<div>
							<div class="subtitle">이메일</div>
							<div>
								<input class="findinput" type="email" name="member_email" id="pw_memberemail" placeholder="이메일을 입력해주세요"> 
								<input class="pwbtn" type="submit">
							</div>
						</div>
					</div>
				</form>

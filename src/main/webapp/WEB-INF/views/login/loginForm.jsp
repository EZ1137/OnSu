			...
			<div id="f">
				<div class="loginForm">
					...
					<div class="socialLogin">
						<div>
							<a href="${naver}"> 
							<img width="200" src="${pageContext.request.contextPath}/resources/img/네이버_아이디로_로그인_완성형_Green.PNG" /></a>
						</div>
						<div>
							<a href="${goolge_url}">
							<img width="223" src="${pageContext.request.contextPath}/resources/img/구글로그인.png"/></a>
						</div>
					</div>
				...
				<div class="forRegist">
					...
					<a href="<c:url value="/registForm.do"/>">
						<button class="registbtn">가입하러 가기</button>
					</a>
				</div>
			</div>

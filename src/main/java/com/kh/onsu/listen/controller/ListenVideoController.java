...
public class ListenVideoController {
	...
	@RequestMapping(value = "/video/listen")
	...
	@RequestMapping(value = "/video/listenDetail")
	...
	@RequestMapping(value = "/video/listenInsert")
	...
	@RequestMapping(value = "/video/listenDelete")
	public String delete(int listen_vclassno) {
		logger.info("[listenVDelete]");
		
		int res = listenVideoBiz.delete(listen_vclassno);
		if (res > 0) {
			return "redirect:video/listenList";
		}
		return "redirect:video/listenDetail?listen_vno=" + listen_vclassno;
	}
}
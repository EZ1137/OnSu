...
public class UploadController {
	...
	public void upload(@RequestParam("file") MultipartFile file, Model model, HttpServletRequest request)
			throws IOException {
	...
	// 다중 파일
	@RequestMapping(value = "/uploadtest1.do", method = RequestMethod.POST)
	public String uploadMany(MultipartHttpServletRequest multifile, Model model, HttpServletRequest request)
			throws IOException {
